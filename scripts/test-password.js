...
bcrypt.compare(password, hash).then(result => {
  if (result) {
    ...
    console.log('The password "eyesonme" matches the hash!');
  } else {
    console.log('❌ Password verification FAILED');
    console.log('The password "eyesonme" does NOT match the hash.');
    console.log('\nGenerating new hash for "eyesonme"...');
