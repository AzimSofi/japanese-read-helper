...
export default function BottomSheet({
  ...
  return (
    <>
      ...
      <div
        ref={sheetRef}
        className={`fixed bottom-0 left-0 right-0 z-[101] ${heightClass} overflow-y-auto transition-transform duration-300`}
        style={{
      ...
      >
        <div className="sticky top-0 z-10 pt-2 pb-0" style={{ backgroundColor: '#FFFFFF', borderRadius: '20px 20px 0 0' }}>
          <div className="flex justify-center mb-2">
            <div className="w-9 h-1 rounded-full" style={{ backgroundColor: '#D1D1D6' }} />
          </div>

          {title && (
            <div className="flex items-center justify-between px-5 pb-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
